          ...
          {showSuccess ? (
            ...
            <>
              ...
              <form onSubmit={handleSubmit}>
                <label htmlFor="tipoIncidente" className="block font-medium text-white">
                  Tipo de incidente:
                </label>
                <select
                  id="tipoIncidente"
                ...
                <label htmlFor="panicDesc" className="block font-medium mt-2 text-white">
                ...
                <label htmlFor="panicFiles" className="block font-medium mt-2 text-white">
